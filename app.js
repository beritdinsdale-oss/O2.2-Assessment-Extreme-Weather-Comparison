...
x.setAttribute('aria-selected',String(on))});document.querySelectorAll('.climate-view').forEach(v=>v.classList.remove('active'));document.querySelector('#'+b.dataset.climate+'Visual').classList.add('active')}));
const seasonData=[
